...
func metadataFields(objectName string) map[string]*schema.Schema {
	return map[string]*schema.Schema{
		"annotations": {
			...
			ValidateFunc:     validate.Annotations,
...
func seedMetadataSchema(objectName string, generatableName bool) *schema.Schema {
	...
	if generatableName {
		fields["generate_name"] = &schema.Schema{
			...
			ValidateFunc:  validate.GenerateName,
